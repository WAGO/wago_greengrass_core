// --------- This code has been automatically generated !!! 2020-01-07T20:42:29.045Z
"use strict";
...
var schema = require("../schemas/HistoryReadResponse_schema").HistoryReadResponse_Schema;
var ResponseHeader = require("./_auto_generated_ResponseHeader").ResponseHeader;
var HistoryReadResult = require("./_auto_generated_HistoryReadResult").HistoryReadResult;
 ...
 * @param  [options.results] {HistoryReadResult[]} 
 * @param  [options.diagnosticInfos] {DiagnosticInfo[]} 
 */
function HistoryReadResponse(options)
{
    options = options || {};
    ...
    if (options.results) {
        ...
        self.results = options.results.map(function(e){ return new HistoryReadResult(e); } );
    }
...
util.inherits(HistoryReadResponse,BaseUAObject);
HistoryReadResponse.prototype.encodingDefaultBinary = makeExpandedNodeId(667,0);
HistoryReadResponse.prototype.encodingDefaultXml = makeExpandedNodeId(666,0);
HistoryReadResponse.prototype._schema = schema;
 ...
 */
HistoryReadResponse.prototype.encode = function(stream,options) {
 ...
 * @param [option] {object} 
 */
HistoryReadResponse.prototype.decode = function(stream,options) {
    // call base class implementation first
...
register_class_definition("HistoryReadResponse",HistoryReadResponse);
