// --------- This code has been automatically generated !!! 2020-01-07T20:42:29.083Z
"use strict";
...
function ContentFilter(options)
{
    ...
    if (options.elements) {
        ...
        self.elements = options.elements.map(function(e){ return new ContentFilterElement(e); } );
    }

   // Object.preventExtensions(self);
}
util.inherits(ContentFilter,BaseUAObject);
ContentFilter.prototype.encodingDefaultBinary = makeExpandedNodeId(588,0);
ContentFilter.prototype.encodingDefaultXml = makeExpandedNodeId(587,0);
ContentFilter.prototype._schema = schema;
 ...
 */
ContentFilter.prototype.encode = function(stream,options) {
...
ContentFilter.prototype.decode = function(stream,options) {
    ...
    this.elements = decodeArray(stream, function(stream) { 
       var obj = new ContentFilterElement();
