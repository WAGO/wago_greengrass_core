// --------- This code has been automatically generated !!! 2020-01-07T20:42:29.135Z
"use strict";
...
var schema = require("../schemas/AddNodesResponse_schema").AddNodesResponse_Schema;
var ResponseHeader = require("./_auto_generated_ResponseHeader").ResponseHeader;
var AddNodesResult = require("./_auto_generated_AddNodesResult").AddNodesResult;
 ...
 * @param  [options.results] {AddNodesResult[]}  
 * @param  [options.diagnostics] {DiagnosticInfo[]}  
 */
function AddNodesResponse(options)
{
    options = options || {};
    ...
    if (options.results) {
        ...
        self.results = options.results.map(function(e){ return new AddNodesResult(e); } );
    }
    ...
    if (options.diagnostics) {
        assert(_.isArray(options.diagnostics));
        self.diagnostics = options.diagnostics.map(function(e){ return new DiagnosticInfo(e); } );
    }

   // Object.preventExtensions(self);
}
util.inherits(AddNodesResponse,BaseUAObject);
AddNodesResponse.prototype.encodingDefaultBinary = makeExpandedNodeId(491,0);
AddNodesResponse.prototype.encodingDefaultXml = makeExpandedNodeId(490,0);
AddNodesResponse.prototype._schema = schema;
 ...
 */
AddNodesResponse.prototype.encode = function(stream,options) {
   ...
   this.responseHeader.encode(stream,options);
    ...
    encodeArray(this.diagnostics,stream,function(obj,stream){ obj.encode(stream,options); }); 
};
/**
 ...
 * @param [option] {object} 
 */
AddNodesResponse.prototype.decode = function(stream,options) {
    // call base class implementation first
    ...
    this.results = decodeArray(stream, function(stream) { 
       var obj = new AddNodesResult();
       obj.decode(stream,options);
       return obj; 
    });
    this.diagnostics = decodeArray(stream, function(stream) { 
...
register_class_definition("AddNodesResponse",AddNodesResponse);
