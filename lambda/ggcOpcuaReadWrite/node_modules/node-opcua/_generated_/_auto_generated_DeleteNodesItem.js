// --------- This code has been automatically generated !!! 2020-01-07T20:42:29.139Z
"use strict";
...
var schema = require("../schemas/DeleteNodesItem_schema").DeleteNodesItem_Schema;
 ...
 * @param  [options.deleteTargetReferences] {Boolean} 
 */
 ...
 * @param [option] {object} 
 */
DeleteNodesItem.prototype.decode = function(stream,options) {
    // call base class implementation first
    BaseUAObject.prototype.decode.call(this,stream,options);
    this.nodeId = decode_NodeId(stream,options);
    this.deleteTargetReferences = decode_Boolean(stream,options);
};
