// --------- This code has been automatically generated !!! 2020-01-07T20:42:29.054Z
"use strict";
...
var schema = require("../schemas/HistoryUpdateResponse_schema").HistoryUpdateResponse_Schema;
var ResponseHeader = require("./_auto_generated_ResponseHeader").ResponseHeader;
var HistoryUpdateResult = require("./_auto_generated_HistoryUpdateResult").HistoryUpdateResult;
 ...
 * @param  [options.results] {HistoryUpdateResult[]} 
 * @param  [options.diagnosticInfos] {DiagnosticInfo[]} 
 */
function HistoryUpdateResponse(options)
{
    options = options || {};
    ...
    if (options.results) {
        ...
        self.results = options.results.map(function(e){ return new HistoryUpdateResult(e); } );
    }
...
util.inherits(HistoryUpdateResponse,BaseUAObject);
HistoryUpdateResponse.prototype.encodingDefaultBinary = makeExpandedNodeId(703,0);
HistoryUpdateResponse.prototype.encodingDefaultXml = makeExpandedNodeId(702,0);
HistoryUpdateResponse.prototype._schema = schema;
 ...
 */
HistoryUpdateResponse.prototype.encode = function(stream,options) {
 ...
 * @param [option] {object} 
 */
HistoryUpdateResponse.prototype.decode = function(stream,options) {
    // call base class implementation first
    ...
    this.results = decodeArray(stream, function(stream) { 
       var obj = new HistoryUpdateResult();
...
register_class_definition("HistoryUpdateResponse",HistoryUpdateResponse);
