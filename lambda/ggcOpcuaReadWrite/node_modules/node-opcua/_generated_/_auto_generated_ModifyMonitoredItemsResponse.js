// --------- This code has been automatically generated !!! 2020-01-07T20:42:28.996Z
"use strict";
...
var schema = require("../schemas/ModifyMonitoredItemsResponse_schema").ModifyMonitoredItemsResponse_Schema;
var ResponseHeader = require("./_auto_generated_ResponseHeader").ResponseHeader;
var MonitoredItemModifyResult = require("./_auto_generated_MonitoredItemModifyResult").MonitoredItemModifyResult;
 ...
 * @param  [options.results] {MonitoredItemModifyResult[]} 
 * @param  [options.diagnosticInfos] {DiagnosticInfo[]} 
 */
function ModifyMonitoredItemsResponse(options)
{
    options = options || {};
    ...
    if (options.results) {
        ...
        self.results = options.results.map(function(e){ return new MonitoredItemModifyResult(e); } );
    }
...
util.inherits(ModifyMonitoredItemsResponse,BaseUAObject);
ModifyMonitoredItemsResponse.prototype.encodingDefaultBinary = makeExpandedNodeId(766,0);
ModifyMonitoredItemsResponse.prototype.encodingDefaultXml = makeExpandedNodeId(765,0);
ModifyMonitoredItemsResponse.prototype._schema = schema;
 ...
 */
ModifyMonitoredItemsResponse.prototype.encode = function(stream,options) {
 ...
 * @param [option] {object} 
 */
ModifyMonitoredItemsResponse.prototype.decode = function(stream,options) {
    // call base class implementation first
    ...
    this.results = decodeArray(stream, function(stream) { 
       var obj = new MonitoredItemModifyResult();
...
register_class_definition("ModifyMonitoredItemsResponse",ModifyMonitoredItemsResponse);
