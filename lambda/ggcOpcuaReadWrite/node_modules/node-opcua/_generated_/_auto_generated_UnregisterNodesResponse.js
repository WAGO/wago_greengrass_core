...
var schema = require("../schemas/UnregisterNodesResponse_schema").UnregisterNodesResponse_Schema;
 ...
 */
function UnregisterNodesResponse(options)
{
    options = options || {};
...
util.inherits(UnregisterNodesResponse,BaseUAObject);
UnregisterNodesResponse.prototype.encodingDefaultBinary = makeExpandedNodeId(569,0);
UnregisterNodesResponse.prototype.encodingDefaultXml = makeExpandedNodeId(568,0);
UnregisterNodesResponse.prototype._schema = schema;
 ...
 */
UnregisterNodesResponse.prototype.encode = function(stream,options) {
 ...
 * @param [option] {object} 
 */
UnregisterNodesResponse.prototype.decode = function(stream,options) {
    // call base class implementation first
...
register_class_definition("UnregisterNodesResponse",UnregisterNodesResponse);
